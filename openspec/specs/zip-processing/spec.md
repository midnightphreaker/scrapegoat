# zip-processing Specification

## Purpose
Defines how archive files (ZIP, TAR, TGZ) are traversed as directories during scraping, including local archive support, web root archive URLs, and nested archive exclusion.
