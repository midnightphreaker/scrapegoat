# pipeline-recovery Specification

## Purpose
Defines how interrupted scrape jobs are handled at PipelineManager startup, including fail-marking and recovery mechanisms.
