# search-result-reassembly Specification

## Purpose
Defines how search result chunks are grouped by URL, clustered by proximity, routed to content-type-specific assembly strategies, context-expanded, joined, and scored.
