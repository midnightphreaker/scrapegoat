...
3. Environment variable (`SCRAPEGOAT_EMBEDDINGS_VECTOR_DIMENSION`)
...
- **WHEN** `SCRAPEGOAT_EMBEDDINGS_VECTOR_DIMENSION` is set to `768`
...
- **WHEN** `SCRAPEGOAT_EMBEDDINGS_VECTOR_DIMENSION` is set to `0`
...
- **WHEN** `SCRAPEGOAT_EMBEDDINGS_VECTOR_DIMENSION` is set to `768.5`
- **THEN** the system SHALL reject the configuration with an error message
